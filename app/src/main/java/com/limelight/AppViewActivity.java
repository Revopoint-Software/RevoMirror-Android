...
public class AppViewActivity extends BaseActivity implements AdapterFragmentCallbacks {
    ...
    private LoadingDialog blockingLoadSpinner;
        ...
        public void onServiceConnected(ComponentName className, IBinder binder) {
            ...
            new Thread() {
                ...
                public void run() {
                    ...
                    try {
                        appGridAdapter = new AppGridAdapter(AppViewActivity.this,
                                PreferenceConfiguration.readPreferences(AppViewActivity.this),
                ...
                if (details.state == ComputerDetails.State.OFFLINE) {
                    ...
                    AppViewActivity.this.runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            Toast.makeText(AppViewActivity.this, getResources().getText(R.string.lost_connection), Toast.LENGTH_SHORT).show();
                            finish();
                        }
                    });
                ...
                if (details.state == ComputerDetails.State.ONLINE && details.pairState != PairingManager.PairState.PAIRED) {
                    AppViewActivity.this.runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            // Display a toast to the user and quit the activity
                            Toast.makeText(AppViewActivity.this, getResources().getText(R.string.scut_not_paired), Toast.LENGTH_SHORT).show();
                            finish();
                        }
                    });
    ...
    private void loadAppsBlocking() {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                blockingLoadSpinner = new LoadingDialog(AppViewActivity.this);
                blockingLoadSpinner.show();
            }
        });
...
//                getResources().getString(R.string.applist_refresh_msg), true);
        ...
        switch (item.getItemId()) {
            case START_WITH_QUIT:
                ...
                UiHelper.displayQuitConfirmationDialog(this, new Runnable() {
                    @Override
                    public void run() {
                        ServerHelper.doStart(AppViewActivity.this, app.app, computer, managerBinder);
                    }
                }, null);
                return true;
            ...
            case QUIT_ID:
                ...
                UiHelper.displayQuitConfirmationDialog(this, new Runnable() {
                    ...
                    public void run() {
                        ...
                        ServerHelper.doQuit(AppViewActivity.this, computer,
            ...
            case VIEW_DETAILS_ID:
                Dialog.displayDialog(AppViewActivity.this, getResources().getString(R.string.title_details), app.app.toString(), false);
                return true;
            ...
            case CREATE_SHORTCUT_ID:
                ...
                if (!shortcutHelper.createPinnedGameShortcut(computer, app.app, appBits)) {
                    Toast.makeText(AppViewActivity.this, getResources().getString(R.string.unable_to_pin_shortcut), Toast.LENGTH_LONG).show();
                }
                return true;
    ...
    public int getAdapterFragmentLayoutId() {
        return PreferenceConfiguration.readPreferences(AppViewActivity.this).smallIconMode ?
