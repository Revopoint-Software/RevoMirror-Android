...
import com.limelight.AppViewActivity;
import com.limelight.GameActivity;
import com.limelight.R;
import com.limelight.ShortcutActivity;
...
public class ServerHelper {
    ...
    public static Intent createPcShortcutIntent(Activity parent, ComputerDetails computer) {
        Intent i = new Intent(parent, ShortcutActivity.class);
    ...
    public static Intent createAppShortcutIntent(Activity parent, ComputerDetails computer, NvApp app) {
        ...
        i.putExtra(AppViewActivity.NAME_EXTRA, computer.name);
        i.putExtra(AppViewActivity.UUID_EXTRA, computer.uuid);
        i.putExtra(GameActivity.EXTRA_APP_NAME, app.getAppName());
        i.putExtra(GameActivity.EXTRA_APP_ID, ""+app.getAppId());
        i.putExtra(GameActivity.EXTRA_APP_HDR, app.isHdrSupported());
        i.setAction(Intent.ACTION_DEFAULT);
        return i;
    }
    ...
    public static Intent createStartIntent(Activity parent, NvApp app, ComputerDetails computer,
        ...
        intent.putExtra(GameActivity.EXTRA_HOST, computer.activeAddress.address);
        intent.putExtra(GameActivity.EXTRA_PORT, computer.activeAddress.port);
        intent.putExtra(GameActivity.EXTRA_HTTPS_PORT, computer.httpsPort);
        intent.putExtra(GameActivity.EXTRA_APP_NAME, app.getAppName());
        intent.putExtra(GameActivity.EXTRA_APP_ID, app.getAppId());
        intent.putExtra(GameActivity.EXTRA_APP_HDR, app.isHdrSupported());
        intent.putExtra(GameActivity.EXTRA_UNIQUEID, managerBinder.getUniqueId());
        intent.putExtra(GameActivity.EXTRA_PC_UUID, computer.uuid);
        intent.putExtra(GameActivity.EXTRA_PC_NAME, computer.name);
        try {
            if (computer.serverCert != null) {
                intent.putExtra(GameActivity.EXTRA_SERVER_CERT, computer.serverCert.getEncoded());
            }
