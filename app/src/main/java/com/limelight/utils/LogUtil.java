...
public class LogUtil {
    ...
    public interface LogInterface{
        void initDefault(String logDirPath);
    ...
    private static LogInterface sLogInterface = null;
    ...
    /**
     * 日志管理初始化
     * @param logDirPath 日志文件存储目录
     * @param logInterface 自定义日志管理接口
     */
    public static void initDefault(String logDirPath, LogInterface logInterface){
        sLogInterface = logInterface;
        try {
            if(sLogInterface != null){
                //使用自定义日志管理输出日志
                sLogInterface.initDefault(logDirPath);
            }else{
                //使用自有处理管理输出日志
                LogUtil.setLogDirPath(logDirPath);
                LogUtil.setOpenLogcatLog(true);
            }
        } catch (Exception ex) {
            ex.printStackTrace();
        }
     ...
     * @throws Exception
     */
    private static void setLogDirPath(String dirPath) throws Exception {
     ...
     * @param maxFileCount
     */
    private static void setLogFileMaxCount(int maxFileCount) {
     ...
     * @param maxFileSize
     */
    private static void setLogFileMaxSize(int maxFileSize) {
     ...
     * @param openLogcatLog
     */
    private static void setOpenLogcatLog(boolean openLogcatLog) {
