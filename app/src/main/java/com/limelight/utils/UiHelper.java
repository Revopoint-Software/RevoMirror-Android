...
import com.limelight.ui.dialog.ConfirmDialog;
...
public class UiHelper {
    ...
    public static void displayDeletePcConfirmationDialog(Activity parent, ComputerDetails computer, final Runnable onYes, final Runnable onNo) {
        /*ConfirmDialog confirmDialog = new ConfirmDialog(parent);
        confirmDialog.setMessage(parent.getResources().getString(R.string.DeletePcTip))
                .setTitle(computer.name)
                .setPositiveButton(parent.getResources().getString(R.string.Confirm), new ConfirmDialog.OnDialogClickListener() {
                    @Override
                    public void onDialogClick(ConfirmDialog dialog) {
                        if (onYes != null) {
                            onYes.run();
                        }
                    }
                })
                .setNegtiveButton(parent.getResources().getString(R.string.Cancel), new ConfirmDialog.OnDialogClickListener() {
                    @Override
                    public void onDialogClick(ConfirmDialog dialog) {
                        if (onNo != null) {
                            onNo.run();
