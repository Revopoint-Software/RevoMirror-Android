...
import com.limelight.ui.dialog.LoadingDialog;
...
import com.limelight.view.TouchControlLayout;
...
public class GameActivity extends BaseActivity implements SurfaceHolder.Callback,
    ...
    private ServiceConnection usbDriverServiceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            ...
            binder.setStateListener(GameActivity.this);
            binder.start();
...
//                getResources().getString(R.string.conn_establishing_msg), true);
        spinner = new LoadingDialog(this);
        spinner.show();

        // Read the stream preferences
        prefConfig = PreferenceConfiguration.readPreferences(this);
        tombstonePrefs = GameActivity.this.getSharedPreferences("DecoderTombstone", 0);
        ...
        touchControlLayout = findViewById(R.id.touchControlLayout);
        touchControlLayout.setDispatchTouchView(streamView);
        ...
        appName = GameActivity.this.getIntent().getStringExtra(EXTRA_APP_NAME);
        pcName = GameActivity.this.getIntent().getStringExtra(EXTRA_PC_NAME);

        String host = GameActivity.this.getIntent().getStringExtra(EXTRA_HOST);
        int port = GameActivity.this.getIntent().getIntExtra(EXTRA_PORT, NvHTTP.DEFAULT_HTTP_PORT);
        int httpsPort = GameActivity.this.getIntent().getIntExtra(EXTRA_HTTPS_PORT, 0); // 0 is treated as unknown
        int appId = GameActivity.this.getIntent().getIntExtra(EXTRA_APP_ID, StreamConfiguration.INVALID_APP_ID);
        String uniqueId = GameActivity.this.getIntent().getStringExtra(EXTRA_UNIQUEID);
        boolean appSupportsHdr = GameActivity.this.getIntent().getBooleanExtra(EXTRA_APP_HDR, false);
        byte[] derCertData = GameActivity.this.getIntent().getByteArrayExtra(EXTRA_SERVER_CERT);
    ...
    private final Runnable hideSystemUi = new Runnable() {
            ...
            public void run() {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N && isInMultiWindowMode()) {
                    GameActivity.this.getWindow().getDecorView().setSystemUiVisibility(
                            View.SYSTEM_UI_FLAG_LAYOUT_STABLE);
                }
                else {
                    // Use immersive mode
...
//                normalizedY = (normalizedY - dy) / streamView.getScaleY();
                ...
                Pair<Integer, Integer> pos = streamView.getConvertEventPos(normalizedX, normalizedY);
                normalizedX = pos.first;
                normalizedY = pos.second;
    ...
    private boolean handleMotionEvent(View view, MotionEvent event) {
                 ...
                 eventSource == InputDevice.SOURCE_MOUSE_RELATIVE)
        {
            ...
            else
            {
                ...
                LogUtil.i("StreamView  aaaa " + eventX + ", " + eventY);
                LogUtil.i("StreamView  aaaa " + streamView.getX() + ", " + streamView.getY());
...
//                }
            ...
            public void run() {
                ...
                if (!displayedFailureDialog) {
                    ...
                    if (stage.contains("video") && streamView.getHolder().getSurface().isValid()) {
                        Toast.makeText(GameActivity.this, getResources().getText(R.string.video_decoder_init_failed), Toast.LENGTH_LONG).show();
                    }
                    ...
                    Dialog.displayDialog(GameActivity.this, getResources().getString(R.string.conn_error_title), dialogText, true);
                }
            }
        });
    }
            ...
            public void run() {
                ...
                if (!displayedFailureDialog) {
                    ...
                    if (errorCode != MoonBridge.ML_ERROR_GRACEFUL_TERMINATION) {
                        ...
                        Dialog.displayDialog(GameActivity.this, getResources().getString(R.string.conn_terminated_title),
                                message, true);
                    }
                    else {
                        finish();
    ...
    public void connectionStarted() {
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                UiHelper.notifyStreamConnected(GameActivity.this);
        ...
        computer.uuid = GameActivity.this.getIntent().getStringExtra(EXTRA_PC_UUID);
    ...
    public void surfaceChanged(SurfaceHolder holder, int format, int width, int height) {
        ...
        if (!attemptedConnection) {
            ...
            UiHelper.notifyStreamConnecting(GameActivity.this);

            decoderRenderer.setRenderTarget(holder);
            conn.start(new AndroidAudioRenderer(GameActivity.this, prefConfig.enableAudioFx),
                    decoderRenderer, GameActivity.this);
        }
    }
