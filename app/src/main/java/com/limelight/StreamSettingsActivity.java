...
public class StreamSettingsActivity extends BaseActivity {
    ...
    public void onBackPressed() {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.TIRAMISU) {
            ...
            if (!newPrefs.language.equals(previousPrefs.language)) {
                ...
                Intent intent = new Intent(this, PcViewActivity.class);
                ...
                public boolean onPreferenceChange(Preference preference, Object newValue) {
                    ...
                    h.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            StreamSettingsActivity settingsActivity = (StreamSettingsActivity) SettingsFragment.this.getActivity();
