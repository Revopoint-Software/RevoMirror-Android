...
public class PcGridAdapter extends GenericGridAdapter<PcViewActivity.ComputerObject> {
    ...
    public void addComputer(PcViewActivity.ComputerObject computer) {
        itemList.add(computer);
        sortList();
    }

    private void sortList() {
        Collections.sort(itemList, new Comparator<PcViewActivity.ComputerObject>() {
            @Override
    ...
    public boolean removeComputer(PcViewActivity.ComputerObject computer) {
        return itemList.remove(computer);
    }

    @Override
    public void populateView(View parentView, ImageView imgView, ProgressBar prgView, TextView txtView, ImageView overlayView, PcViewActivity.ComputerObject obj) {
        imgView.setImageResource(R.drawable.ic_mirror_normal);
